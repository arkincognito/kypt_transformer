...
class Config:
    ...
    shape_reg_weight = 0 * 2 / 10  # L2 regularization on the shape values
    joint_weight = 1 / 10
    joint_2d_weight = 1 / 100
    vertex_weight = 0 * 1 / 100  # Used for angle training
    cls_weight = 1 / 1  # JointClassificationLoss. keypoint-joint association
    hand_type_weight = 0 * 100
    cam_trans_weight = 10 / 100 / 2
    cam_scale_weight = 1 / 100 / 2
    shape_weight = 5
    inter_joint_weight = 0 * 1 / 100  # TODO: Figure out where this goes.
    joint_vec_weight = 1
